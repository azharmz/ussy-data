"""Load and validate the governed close-basis shared EMA state from R2."""
...
from ema_close_state import PERIODS, PRICE_BASIS, validate_state_frame

EMA_POINTER_KEY = "production/indicators/ema-close/current.json"
EMA_RUN_PREFIX = "production/indicators/ema-close/runs/"
PROMOTION_POLICY = "candidate_then_equivalence_then_immutable_run_then_current_pointer_last_v1"


def load_ema_close_state(s3, bucket):
    import pandas as pd
