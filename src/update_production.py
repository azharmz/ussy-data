...
def main() -> None:
    ...
    readiness = {
        ...
        "ready": len(ready_ids),
        "insufficient_history": len(insufficient_ids),
        "data_unavailable": len(unavailable_ids),
        "update_failures": len(failures),
        "rolling_rows": len(rolling),
        "ready_security_ids": ready_ids,
        "insufficient_history_security_ids": insufficient_ids,
